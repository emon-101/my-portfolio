...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    ...
    >
      {/* 🖼 Image */}
      <div
        className={`relative w-full h-[220px] sm:h-[260px] md:h-full overflow-hidden 
      ...
      <div
        ...
        ${isReverse ? "md:order-1 md:text-right" : ""}`}
      >
        ...
        {/* 🔗 Links */}
        <div
          className={`flex gap-6 mt-6 text-sm md:text-base 
          ${isReverse ? "md:justify-end" : ""}`}
        >
          <a
            href={project.github}
